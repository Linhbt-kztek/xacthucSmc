 ...
 $(document).ready(function(){
    $('td.headlink').hover(
	    function(){
		    ...
		    $('td.headlink ul li >a').removeClass('active');
		    ...
		    $('li.list').hover(
			    function(){
				    ...
				    $('>ul',this).css({'display':'block'});
				    $('>ul',this).css({'padding-top':$(this).height() * -1});
			    },
			    function(){
...
function flash(url,w,h){
    ...
    str=str+'<embed wmode="transparent" src="'+url+'" quality="high" width="'+w+'" height="'+h+'" name="tech" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />'
    str=str+'</object>'
    document.write(str);
}

function delt(div,id){
    $(div).load("/youtube.aspx?id="+id);
