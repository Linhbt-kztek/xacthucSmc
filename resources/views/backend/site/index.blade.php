...
<div class="content">
    ...
    <section class="content-header">
        ...
        <small>@if(Auth::user()->hasAnyRole([2]))
          Tên doanh nghiệp: <b> {{Auth::user()->company->name}} </b>
          @endif
       ...
       <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{number_format($partner)}}<sup style="font-size: 20px"></sup></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3> {{number_format($activeqrcode)}}</h3>
				        			...
				        			<tbody>
				        				@forelse ($listHistory as $key => $item)
				              			<tr>
								          	...
								          	<td>{{$item->SP_ma}}</td>
								          	<td>{{ \Carbon\Carbon::parse($item->BH_time)->format('d/m/Y g:i:s A')}}</td>
