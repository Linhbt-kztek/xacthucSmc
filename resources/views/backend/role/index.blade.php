...
@if (Session::has('msg_roleGroup'))
   	...
   	$(function() {
   		jAlert('{{Session::get("msg_role")}}', 'Thông báo');
   	});
   	</script>
@endif
			...
			<div class="box box-primary">
				<div class="box-header with-border">
				  	<div class="row">
				  		...
				  		<div class="col-sm-2">
							<a class="btn btn-primary" href="{{route('backend.role.vAdd')}}">Thêm mới Nhóm quyền</a>
						</div>
						@endif
						<div class="col-sm-3">
					...
					<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
						<div class="row">
							<div class="col-sm-1">
								...
								<input type="hidden" id="delUrl" value="{{url('backend/role/delete')}}">
								@endif
							</div>
							<div class="col-sm-11">
				        				...
				        				@forelse ($listRole as $key => $item) 
				              			<tr class="{{$key%2 == 0 ? 'even' : 'odd'}}">
								          	...
								          	<td class="text-center">
								          		@if(Auth::user()->hasAnyRole([1]))
								          		<a href="{{route('backend.role.vEdit',['id'=>$item->id])}}" class="editItem" id="" title="Sửa"><i class="fa fa-fw fa-edit"></i></a>
								          		@endif
								          		@if(Auth::user()->hasAnyRole([1]))
	...
	<div class="modal-dialog" role="document">
    	<div class="modal-content">
  			...
  			<div class="form-group">
      			<form id="searchForm" action="{{route('backend.role.index')}}">
	      			<div class="modal-body">
	      				<div class="form-group">
		        			<label for="recipient-name" class="control-label">Tên nhóm quyền:</label>
