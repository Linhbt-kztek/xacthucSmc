...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Thêm mới Nhóm quyền</li>
  </ol>
</section>
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal" action="{{route('backend.role.pAdd')}}" method="POST">
				{{csrf_field()}}
					        ...
					        <div class="col-md-6">
					        	<div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
					              	...
					              	<div class="col-md-9 col-sm-9 col-xs-12">
					              		<input type="text" class="form-control" name="name" id="name" placeholder="Tên nhóm quyền" maxlength="255">
