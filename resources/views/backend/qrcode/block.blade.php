...
<script type="text/javascript" src="{{asset('backend/libout/js/block.page.js')}}"></script>
<section class="content-header">
  <h1>
    Chia khối QRCode
    <small>[{{substr($block->guid,0, 38).']'}}</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <li class="active">{{$block->company->name}}</li>
  </ol>
</section>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      @include('backend.component.partner.addblock')
      @include('backend.component.product.addblock')
    </div>
  </div>
</section>
...
<input type="hidden" id="getFormUrl" value="{{url('qrcode/getForm')}}">
<!-- begin modal add -->
