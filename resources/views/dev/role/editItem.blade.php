...
@section('title', 'Update Role Item')
@section('content')
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Update Role Item</li>
  </ol>
</section>
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('dev.role.pEditItem',['id'=>$model->id])}}" method="POST">
				{{csrf_field()}}
					        ...
					        <div class="col-md-6">
					            ...
					            <!-- /.form-group -->
					          	...
					          	<div class="form-group">
				                  	...
				                  	<textarea name="description" id="description" class="form-control" rows="3" value="{{$model->name}}" placeholder="Enter ..."></textarea>
				                </div>
					            <!-- /.form-group -->
					        </div>
					        <!-- /.col -->
