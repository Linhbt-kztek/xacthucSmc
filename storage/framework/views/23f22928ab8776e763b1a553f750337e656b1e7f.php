...
<head>
  ...
  <title>Smartcheck Admin | <?php echo $__env->yieldContent('title'); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('backend/libout/css/style.css')); ?>">
  <!-- jAlert style -->
  <link rel="stylesheet" href="<?php echo e(asset('backend/libout/css/jquery.alerts.css')); ?>">
...
<script type="text/javascript" src="<?php echo e(asset('backend/summernote/summernote.js')); ?>"></script>
  ...
  <!-- jQuery UI 1.11.4 -->
  <script src="<?php echo e(asset('backend/libout/js/jquery-ui.min.js')); ?>"></script>
  ...
  <!-- daterangepicker -->
  <script src="<?php echo e(asset('backend/libout/js/moment.min.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/plugins/daterangepicker/daterangepicker.js')); ?>"></script>
  <!-- jAlert -->
  <script src="<?php echo e(asset('backend/libout/js/jquery.alerts.js')); ?>"></script>
  <!-- datepicker -->
  ...
  <!-- Style js -->
  <script src="<?php echo e(asset('backend/libout/js/style.js')); ?>"></script>
  <script type="text/javascript">
    var url_upload_content = '<?php echo e(url("site/uploadImageContent")); ?>';
  </script>
  <style>
...
<div class="wrapper"  style="background: #FFF;">
  <header class="main-header"  style="background: #FFF;">
    <!-- Logo -->
    <a href="<?php echo e(route('backend.site.index')); ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"> <img src="<?php echo e(asset('backend/dist/img/logochuan-dung-1024x388.png')); ?>" height="40" class="user-image" alt="User Image"></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo e(route('backend.user.profile')); ?>" class="1dropdown-toggle" data-toggle="1dropdown">
              <img src="<?php echo e(Auth::user()->introimage != '' ? asset(Auth::user()->introimage) : asset('backend/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo e(Auth::user()->fullname); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(Auth::user()->introimage != '' ? asset(Auth::user()->introimage) : asset('backend/dist/img/user2-160x160.jpg')); ?>" class="rounded" alt="User Image">

                <p>
                  <?php echo e(Auth::user()->fullname); ?>B
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('backend.user.profile')); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo e(route('backend.site.logout')); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          <li>
               <a href="<?php echo e(route('backend.site.logout')); ?>" "> <i class="fa fa-sign-out" aria-hidden="true"></i> Thoát</a>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo e(isset(Auth::user()->company) ? Auth::user()->company->name : Auth::user()->fullname); ?></p>
          <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
        </div>
      </div>
     
      <!-- sidebar menu: : style can be found in sidebar.less -->
      <?php echo $__env->make("backend.component.menu", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
