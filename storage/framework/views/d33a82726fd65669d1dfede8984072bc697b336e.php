...
<?php $__env->startSection('title', 'Cập nhật doanh nghiệp'); ?>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo e(route('backend.company.pEdit',['id'=>$model->id])); ?>" method="POST" enctype="multipart/form-data">
				      	...
				      	<div class="row">
					        <div class="col-md-6 col-sm-6 col-xs-12">
					        	...
					        	<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
					              	...
					              	<input type="text" class="form-control" name="name" id="name" value="<?php echo e($model->name); ?>" placeholder="Tên doanh nghiệp" maxlength="255">
					            ...
					            <div class="form-group <?php echo e($errors->has('tel') ? 'has-error' : ''); ?>">
					              	...
					              	<input type="text" class="form-control" name="tel" id="tel" placeholder="Số điện thoại" value="<?php echo e($model->tel); ?>" maxlength="150">
					             ...
					             <div class="form-group <?php echo e($errors->has('tel') ? 'has-error' : ''); ?>">
					              	...
					              	<input type="text" class="form-control" name="facebooklink" id="tel" placeholder="Link facebook" value="<?php echo e($model->facebooklink); ?>" maxlength="150">
					              	<span class="help-block"><?php echo e($errors->first("tel")); ?></span>
					            </div>
					            <!-- /.form-group -->
					            <div class="form-group <?php echo e($errors->has('address') ? 'has-error' : ''); ?>">
					              	<label class="required" for="address">Địa chỉ</label>
					              	<textarea class="form-control" name="address" rows="3" id="address" placeholder="Địa chỉ" maxlength="9999"><?php echo e($model->address); ?></textarea>
					            ...
					            <div class="form-group <?php echo e($errors->has('code_tax') ? 'has-error' : ''); ?>">
					              	...
					              	<input type="text" class="form-control" name="code_tax" id="code_tax" placeholder="Mã số thuế" value="<?php echo e($model->code_tax); ?>" maxlength="50">
					            ...
					            <div class="form-group <?php echo e($errors->has('website') ? 'has-error' : ''); ?>">
					              	...
					              	<input type="text" class="form-control" name="website" id="website" placeholder="Website" value="<?php echo e($model->website); ?>" maxlength="255">
					            ...
					            <div class="form-group <?php echo e($errors->has('intro') ? 'has-error' : ''); ?>">
					              	...
					              	<textarea class="form-control" name="intro" rows="3" id="intro" placeholder="Giới thiệu công ty"><?php echo e($model->intro); ?></textarea>
					            ...
					            <div class="form-group <?php echo e($errors->has('introimage') ? 'has-error' : ''); ?>">
				                  	...
				                  	<p>
				                  		<img src="<?php echo e($model->introimage != '' ? asset($model->introimage) : ''); ?>" id="blah" alt="" style="max-width: 50%;margin-top: 10px;">
				                  	</p>
				                 ...
				                 <div class="form-group <?php echo e($errors->has('intro') ? 'has-error' : ''); ?>">
					              	<label class="" for="intro">Chọn cách chia khối (Mặc định 0 = chia khối theo serial tem/ nếu không muốn nhập số 1)</label>
					              	 	...
					              	 	<input type="number" class="form-control" name="warranty" id="warranty" value="<?php echo e($model->warranty); ?>" maxlength="1" min="0" max="1">
					              	 	<!--
					              	 	<input type="checkbox" id="warranty" name="warranty" value="<?php echo e($model->warranty); ?>">
					              	 	-->
				                ...
				                <div class="form-group <?php echo e($errors->has('asign_to') ? 'has-error' : ''); ?>">
						            ...
						            <select class="form-control" id="asign_to" name="asign_to">
						                ...
						                <option value="<?php echo e($item->id); ?>" <?php echo e(($model->asign_to == $item->id) ? 'selected' : ''); ?>><?php echo e($item->email); ?></option>
