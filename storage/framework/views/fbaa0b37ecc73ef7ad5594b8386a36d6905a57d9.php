...
<?php $__env->startSection('title', 'Khóa code'); ?>
...
<section class="content-header">
  <h1>
    Khóa mã code
    <small>Dùng cho việc khóa code nào đó mà không muốn hiện thị kết quả quét  <?php echo e(isset($company) ? $company->name : ''); ?></small>
  </h1>
  <ol class="breadcrumb">
    ...
    <li class="active">Lịch sử quét <?php echo e(isset($filter['guid']) ? 'GUID: '.substr($filter['guid'], 0, 8).'...' : ''); ?></li>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="box box-primary">
				<div class="box-header with-border">
				  	<div class="row">
						<div class="col-sm-6">
							...
							<?php if(Auth::user()->hasAnyRole([1,2])): ?>
							<button class="btn btn-primary" onclick="previewQrcodeForm('<?php echo e(route('backend.qrcode.previewQrcode')); ?>')">Tạo khóa code mới</button>
							<?php endif; ?>
						</div>
						<div class="col-sm-6">
				...
				<!-- /.box-header -->
				<form id="search-form" action="<?php echo e(route('backend.qrcode.islock')); ?>" method="GET">
					<div class="box box-default collapsed-box" id="box-search">
				        ...
				        <!-- /.box-header -->
				        <div class="box-body">
				        	<input type="hidden" id="guid_active_id" name="guid" value="<?php echo e(isset($filter['guid']) ? $filter['guid'] : ''); ?>">
					            ...
					            <div class="col-md-6">
					              <div class="form-group">
					                ...
					                <select class="form-control" name="partner_id" id="partner_id" style="width: 100%;">
						                ...
						                <option value="<?php echo e($item->id); ?>" <?php echo e((isset($filter['partner_id']) && $filter['partner_id'] == $item->id) ? 'selected' : ''); ?>><?php echo e($item->text); ?></option>
						                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						                <?php endif; ?>
					                </select>
					              </div>
				            ...
				            <div class="row">
					            <div class="col-md-6">
					              <div class="form-group">
					                ...
					                <input type="number" name="serial" value="<?php echo e(isset($filter['serial']) ? $filter['serial'] : ''); ?>" class="form-control">
					              </div>
					              <!-- /.form-group -->
					            </div>
					            <div class="col-md-6">
					              <div class="form-group">
					                ...
					                <input type="text" name="product_name" value="<?php echo e(isset($filter['product_name']) ? $filter['product_name'] : ''); ?>" class="form-control">
					              </div>
					              <!-- /.form-group -->
					            </div>
					            <!-- /.col -->
				        			...
				        			<tbody>
				        				<?php $__empty_1 = true; $__currentLoopData = $listActiveQrcode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
				              			<tr class="<?php echo e($key%2 == 0 ? 'even' : 'odd'); ?>">
								          	...
								          	<td> <span style=" color:<?php echo e($item->islock == 1 ? 'red' : 'green'); ?>"> <i class="fa fa-fw fa-<?php echo e($item->islock == 1 ? 'lock' : 'unlock'); ?>"></i></span> </td>
								          	<td><?php echo e($item->message); ?></td>
							          		<?php if(Auth::user()->hasAnyRole([1,2])): ?>
								          	<td class="text-center">
								          	    <a href="<?php echo e(route('backend.qrcode.islockedit',['id' => $item->id])); ?>" title="Sửa thông tin"><i class="fa fa-fw fa-edit"></i></a>
